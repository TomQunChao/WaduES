...
HD_PWD='D:/workspace/vivadoProjects/WaduES/WaduES.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Control.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Control.tcl
